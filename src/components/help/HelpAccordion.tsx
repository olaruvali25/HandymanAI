            ...
            {items.map((item, index) => (
                ...
                >
                    ...
                    >
                        ...
                        <span
                            className={`ml-4 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-white/20 text-white transition-transform duration-300 ${openIndex === index ? "rotate-180" : ""
                                }`}
                        >
                            <svg
                                width="12"
