...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer text-sidebar-foreground hidden w-fit shrink-0 md:block"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) shrink-0 bg-transparent transition-[width] duration-300 ease-in-out",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) shrink-0 transition-[left,right,width] duration-300 ease-in-out md:flex",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("bg-sidebar-border m-2 w-4/5 self-center", className)}
      {...props}
    />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto transition-opacity duration-200 ease-in-out group-data-[collapsible=icon]:pointer-events-none group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:opacity-0",
        className,
      )}
      {...props}
    />
...
>(({ className, showIcon = false, width = "70%", ...props }, ref) => {
  return (
    ...
    >
      {showIcon && (
        <Skeleton
          className="bg-sidebar-foreground/15 size-4 rounded-md"
          data-sidebar="menu-skeleton-icon"
        />
      )}
      <Skeleton
        className="bg-sidebar-foreground/10 h-4 max-w-[--skeleton-width] flex-1"
