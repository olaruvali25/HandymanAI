        ...
        <Container>
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-[var(--muted)] sm:text-xl">
              Find answers to common questions about using Fixly, managing your
              credits, and staying safe during repairs.
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="pb-24 lg:pb-32">
        <Container>
          <div className="mx-auto max-w-3xl">
            <h2 className="font-display mb-12 text-3xl font-semibold text-white">
